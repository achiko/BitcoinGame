			...
			async.series([
				...
				function(err, results){
							...
							if(err) { 
										...
										console.log(err);
										response = { "ErrorCode": 100 };   callback(null, response ); 
...
exports.userssession  =  function(db, Models, client , _username, _usersession, callback) 
{
       ...
       var _newbtcaddress = null;
       var _newbtcaccount = null;
			 ...
			 async.series([
			 			...
			 			function(callback)
			 			{
			 						client.cmd('getnewaddress', id, function (err, addr) {
       									...
       									console.log('New address is: ', addr);
       									_newbtcaddress = addr;
			 			...
			 			function(callback)
			 			{
			 					...
			 					client.cmd('getaccount', _newbtcaddress, function (err, account) {
			 			...
			 			function(callback)
			 			{
								...
								var user = new Models.users ({
												...
												BTCAdress 		: 	_newbtcaddress,
												BTCAccount		:   _newbtcaccount,
												balance				: 	0.0
								});
